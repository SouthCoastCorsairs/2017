...
import org.usfirst.frc.team5846.robot.commands.SecondAuto;
import org.usfirst.frc.team5846.robot.commands.ThirdAuto;
...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		oi = new OI();
		chooser.addObject("Middle Peg", new ThirdAuto());
		 //This is the autonomous chooser for SmartDashboard 
		chooser.addObject("Right Peg", new SecondAuto());
		chooser.addDefault("Left Peg", new Auto());
		chooser.addObject("Pixy", new PixyCmd());
	...
	public void autonomousPeriodic() {
		...
		SmartDashboard.putNumber("Encoder", Robot.drivetrain.driveEncoder.get());
		SmartDashboard.putNumber("Distance", Robot.drivetrain.driveEncoder.getDistance());
